...
impl ConvInitializers {
    pub fn gen_image(&self, nrow: usize, ncol: usize, nchan: usize, nsample: usize) -> Image {
        match self {
            ...
            ConvInitializers::Uniform => Image::random_uniform(nrow, ncol, nchan, nsample, 0.0, 1.0),
            ConvInitializers::UniformSigned => Image::random_uniform(nrow, ncol, nchan, nsample, -1.0, 1.0),
