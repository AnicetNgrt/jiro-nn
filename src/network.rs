...
impl<const IN: usize, const OUT: usize> Network<IN, OUT> {
    ...
    pub fn fit<const S: usize>(&mut self, x_train: SMatrix<f64, IN, S>, y_train: SMatrix<f64, OUT, S>, epochs: usize,  learning_rate: f64, loss: Loss<OUT>) -> Vec<f64> {
    ...
    pub fn fit_iter<const S: usize, I>(&mut self, x_train: I, y_train: I, epochs: usize,  learning_rate: f64, loss: Loss<OUT>) -> Vec<f64> 
    where
        I: IntoIterator<Item = f64>
    {
        self.fit::<S>(
